...
class LoggingInterceptor extends Interceptor {
  ...
  ///
  /// [dioException] contains error info when the request failed.
  ...
  void onError(
    ...
    debugPrint('--> ERROR');
    final httpMethod = dioException.requestOptions.method.toUpperCase();
    final url = dioException.requestOptions.baseUrl + dioException.requestOptions.path;
    ...
    if (dioException.response != null) {
      ...
      if (dioException.response!.data != null) {
        final headers = dioException.response!.data['headers'] as Map<String, dynamic>; //API Dependant
        ...
        debugPrint('${dioException.response!.data}');
      }
